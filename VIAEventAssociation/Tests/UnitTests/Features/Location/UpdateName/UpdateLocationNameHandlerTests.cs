...
public class UpdateLocationNameHandlerTests
{
    ...
    {
        // Arrange
        Result<UpdateLocationNameCommand> nameCommand = UpdateLocationNameCommand.Create("7c59adac-5a10-4de9-8783-ea2add07bb65", "New Name");
    ...
    {
        // Arrange
        Result<UpdateLocationNameCommand> nameCommand = UpdateLocationNameCommand.Create("7c59adac-5a10-4de9-8783-ea2add07bb65", "");
