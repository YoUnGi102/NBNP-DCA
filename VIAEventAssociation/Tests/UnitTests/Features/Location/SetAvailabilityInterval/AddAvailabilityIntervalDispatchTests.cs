...
public class AddAvailabilityIntervalDispatchTests
{
    ...
    {
        // Arrange
        Result<AddAvailabilityIntervalCommand> result = AddAvailabilityIntervalCommand.Create("7c59adac-5a10-4de9-8783-ea2add07bb65", "2022-12-12", "2022-12-13");
    ...
    {
        // Arrange
        Result<AddAvailabilityIntervalCommand> result = AddAvailabilityIntervalCommand.Create("7c59adac-5a10-4de9-8783-ea2add07bb65", "2022-12-12", "2022-11-12");
        AddAvailabilityIntervalCommand command = result.GetObj()!;
