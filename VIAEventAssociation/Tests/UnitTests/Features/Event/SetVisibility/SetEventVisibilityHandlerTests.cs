...
public class SetEventVisibilityHandlerTests
{
    ...
    {
        // Arrange
        Result<SetEventVisibilityCommand> visibilityCommand = SetEventVisibilityCommand.Create("3b1d8789-e982-41b4-9f77-a7459fd6f51e", "Public");
    ...
    {
        // Arrange
        Result<SetEventVisibilityCommand> visibilityCommand = SetEventVisibilityCommand.Create("3b1d8789-e982-41b4-9f77-a7459fd6f51e", "Private");
    ...
    {
        // Arrange
        Result<SetEventVisibilityCommand> visibilityCommand = SetEventVisibilityCommand.Create("", "InvalidVisibility");
